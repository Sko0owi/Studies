    ...
    while(!kol.empty())
    {
        ...
        if(cells[top.second].resourceType != kEmpty)
        {
            if(cells[top.second].resourceType == kCrystal)
            {
                ...
                if(shortestDist[0][top.second] == 1) weightCrytal = 4;
                if(shortestDist[0][top.second] == 2) weightCrytal = 3;
                if(shortestDist[0][top.second] == 3) weightCrytal = 2;
                //if(shortestDist[0][top.second] == 4) weightCrytal = 1.5;

                int extracted = min(cells[top.second].chainMe, cells[top.second].resourceCount) * weightCrytal;
